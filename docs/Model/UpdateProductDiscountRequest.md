...
**criteria** | [**\Keap\Core\V2\Model\UpdateProductDiscountCriteria[]**](UpdateProductDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional]
