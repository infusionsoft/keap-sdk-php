...
**criteria** | [**\Keap\Core\V2\Model\UpdateShippingDiscountCriteria[]**](UpdateShippingDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional]
