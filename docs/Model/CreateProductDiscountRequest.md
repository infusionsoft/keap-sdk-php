...
**criteria** | [**\Keap\Core\V2\Model\CreateProductDiscountCriteria[]**](CreateProductDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional]
