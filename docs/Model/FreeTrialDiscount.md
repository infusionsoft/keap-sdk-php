...
**criteria** | [**\Keap\Core\V2\Model\FreeTrialDiscountCriteriaResponse[]**](FreeTrialDiscountCriteriaResponse.md) | List of criteria that must be met for this discount to apply | [optional]
