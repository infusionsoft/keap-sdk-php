...
**shipping_address** | [**\Keap\Core\V2\Model\Address**](Address.md) | The shipping address for the subscription. | [optional]
...
**custom_fields** | [**\Keap\Core\V2\Model\CustomFieldValue[]**](CustomFieldValue.md) | List of custom field values applied to this subscription | [optional]
