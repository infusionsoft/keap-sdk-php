...
**criteria** | [**\Keap\Core\V2\Model\UpdateOrderTotalDiscountCriteria[]**](UpdateOrderTotalDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional]
