...
**criteria** | [**\Keap\Core\V2\Model\CreateShippingDiscountCriteria[]**](CreateShippingDiscountCriteria.md) | List of criteria that must be met for this discount to apply | [optional]
