...
```php
createNoteCustomFieldTab($create_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->createNoteCustomFieldTab($create_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->createNoteCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteNoteCustomFieldTab($tab_id)
```
...
try {
    $apiInstance->deleteNoteCustomFieldTab($tab_id);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->deleteNoteCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteNotesCustomField($custom_field_id)
```
...
try {
    $apiInstance->deleteNotesCustomField($custom_field_id);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->deleteNotesCustomField: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getNoteCustomFieldTab($tab_id): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->getNoteCustomFieldTab($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->getNoteCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listAllNotes($filter, $page_token, $order_by, $page_size, $fields): \Keap\Core\V2\Model\ListNotesResponse
```
...
$order_by = 'order_by_example'; // string | Attribute and direction to order items. One of the following fields: - `id` - `create_time` - `update_time`  One of the following directions: - `asc` - `desc`
$page_size = 0; // int | Total number of items to return per page
$fields = array('fields_example'); // string[] | Comma-delimited list of optional Note properties to include in the response. Allowed values: custom_fields

try {
    $result = $apiInstance->listAllNotes($filter, $page_token, $order_by, $page_size, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->listAllNotes: ', $e->getMessage(), PHP_EOL;
}
```
...
| **order_by** | **string**| Attribute and direction to order items. One of the following fields: - &#x60;id&#x60; - &#x60;create_time&#x60; - &#x60;update_time&#x60;  One of the following directions: - &#x60;asc&#x60; - &#x60;desc&#x60; | [optional] |
...
```php
listNoteCustomFieldTabs(): \Keap\Core\V2\Model\ListCustomFieldTabsResponse
```
...
try {
    $result = $apiInstance->listNoteCustomFieldTabs();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->listNoteCustomFieldTabs: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateNoteCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->updateNoteCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling NoteApi->updateNoteCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
