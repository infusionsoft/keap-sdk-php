...
```php
createOrderCustomFieldGroup($create_custom_field_group_request): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->createOrderCustomFieldGroup($create_custom_field_group_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->createOrderCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createOrderCustomFieldTab($create_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->createOrderCustomFieldTab($create_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->createOrderCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOrderCustomFieldGroup($group_id)
```
...
try {
    $apiInstance->deleteOrderCustomFieldGroup($group_id);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->deleteOrderCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOrderCustomFieldTab($tab_id)
```
...
try {
    $apiInstance->deleteOrderCustomFieldTab($tab_id);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->deleteOrderCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderCustomFieldGroup($group_id): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->getOrderCustomFieldGroup($group_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->getOrderCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderCustomFieldTab($tab_id): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->getOrderCustomFieldTab($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->getOrderCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listOrderCustomFieldGroups($tab_id): \Keap\Core\V2\Model\ListCustomFieldGroupsResponse
```
...
try {
    $result = $apiInstance->listOrderCustomFieldGroups($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->listOrderCustomFieldGroups: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listOrderCustomFieldTabs(): \Keap\Core\V2\Model\ListCustomFieldTabsResponse
```
...
try {
    $result = $apiInstance->listOrderCustomFieldTabs();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->listOrderCustomFieldTabs: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderCustomFieldGroup($group_id, $update_mask, $update_custom_field_group_request): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->updateOrderCustomFieldGroup($group_id, $update_mask, $update_custom_field_group_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->updateOrderCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->updateOrderCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrdersApi->updateOrderCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
