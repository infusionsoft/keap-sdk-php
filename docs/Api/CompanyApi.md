...
```php
createCompanyCustomFieldGroup($create_custom_field_group_request): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->createCompanyCustomFieldGroup($create_custom_field_group_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->createCompanyCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createCompanyCustomFieldTab($create_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->createCompanyCustomFieldTab($create_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->createCompanyCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteCompanyCustomField($custom_field_id)
```
...
try {
    $apiInstance->deleteCompanyCustomField($custom_field_id);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->deleteCompanyCustomField: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteCompanyCustomFieldGroup($group_id)
```
...
try {
    $apiInstance->deleteCompanyCustomFieldGroup($group_id);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->deleteCompanyCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteCompanyCustomFieldTab($tab_id)
```
...
try {
    $apiInstance->deleteCompanyCustomFieldTab($tab_id);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->deleteCompanyCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCompanyCustomFieldGroup($group_id): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->getCompanyCustomFieldGroup($group_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->getCompanyCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCompanyCustomFieldTab($tab_id): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->getCompanyCustomFieldTab($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->getCompanyCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listCompanyCustomFieldGroups($tab_id): \Keap\Core\V2\Model\ListCustomFieldGroupsResponse
```
...
try {
    $result = $apiInstance->listCompanyCustomFieldGroups($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->listCompanyCustomFieldGroups: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listCompanyCustomFieldTabs(): \Keap\Core\V2\Model\ListCustomFieldTabsResponse
```
...
try {
    $result = $apiInstance->listCompanyCustomFieldTabs();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->listCompanyCustomFieldTabs: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateCompanyCustomFieldGroup($group_id, $update_mask, $update_custom_field_group_request): \Keap\Core\V2\Model\CustomFieldGroup
```
...
try {
    $result = $apiInstance->updateCompanyCustomFieldGroup($group_id, $update_mask, $update_custom_field_group_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->updateCompanyCustomFieldGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateCompanyCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->updateCompanyCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CompanyApi->updateCompanyCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
