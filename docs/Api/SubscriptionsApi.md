...
```php
createSubscriptionCustomFieldTab($create_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->createSubscriptionCustomFieldTab($create_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->createSubscriptionCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteSubscriptionCustomFieldTab($tab_id)
```
...
try {
    $apiInstance->deleteSubscriptionCustomFieldTab($tab_id);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->deleteSubscriptionCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSubscriptionCustomFieldTab($tab_id): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->getSubscriptionCustomFieldTab($tab_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->getSubscriptionCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
invoiceSubscription($subscription_id): \Keap\Core\V2\Model\OrderV2
```
...
try {
    $result = $apiInstance->invoiceSubscription($subscription_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->invoiceSubscription: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listSubscriptionCustomFieldTabs(): \Keap\Core\V2\Model\ListCustomFieldTabsResponse
```
...
try {
    $result = $apiInstance->listSubscriptionCustomFieldTabs();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->listSubscriptionCustomFieldTabs: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateSubscriptionCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request): \Keap\Core\V2\Model\CustomFieldTab
```
...
try {
    $result = $apiInstance->updateSubscriptionCustomFieldTab($tab_id, $update_mask, $update_custom_field_tab_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubscriptionsApi->updateSubscriptionCustomFieldTab: ', $e->getMessage(), PHP_EOL;
}
```
