...
class TaskApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateTaskUsingPATCH'] to see the possible values for this operation
     *
     * @throws \Keap\Core\V2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function updateTaskUsingPATCH($task_id, $update_mask = null, $create_update_task_request = null, string $contentType = self::contentTypes['updateTaskUsingPATCH'][0])
    {
        list($response) = $this->updateTaskUsingPATCHWithHttpInfo($task_id, $update_mask, $create_update_task_request, $contentType);
        return $response;
    }
     ...
     */
    public function updateTaskUsingPATCHWithHttpInfo($task_id, $update_mask = null, $create_update_task_request = null, string $contentType = self::contentTypes['updateTaskUsingPATCH'][0])
    {
        $request = $this->updateTaskUsingPATCHRequest($task_id, $update_mask, $create_update_task_request, $contentType);
    ...
    /**
     * Operation updateTaskUsingPATCHAsync
     *
     * Update a Task
     *
     * @param  string $task_id task_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaskUsingPATCHAsync($task_id, $update_mask = null, $create_update_task_request = null, string $contentType = self::contentTypes['updateTaskUsingPATCH'][0])
    {
        return $this->updateTaskUsingPATCHAsyncWithHttpInfo($task_id, $update_mask, $create_update_task_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateTaskUsingPATCHAsyncWithHttpInfo
     *
     * Update a Task
     *
     * @param  string $task_id task_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaskUsingPATCHAsyncWithHttpInfo($task_id, $update_mask = null, $create_update_task_request = null, string $contentType = self::contentTypes['updateTaskUsingPATCH'][0])
    {
    ...
    /**
     * Create request for operation 'updateTaskUsingPATCH'
     *
     * @param  string $task_id task_id (required)
     * @param  string[]|null $update_mask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped. (optional)
     * @param  \Keap\Core\V2\Model\CreateUpdateTaskRequest|null $create_update_task_request task (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaskUsingPATCHRequest($task_id, $update_mask = null, $create_update_task_request = null, string $contentType = self::contentTypes['updateTaskUsingPATCH'][0])
    {

        // verify the required parameter 'task_id' is set
        if ($task_id === null || (is_array($task_id) && count($task_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $task_id when calling updateTaskUsingPATCH'
            );
        }
