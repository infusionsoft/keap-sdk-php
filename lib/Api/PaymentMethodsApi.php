...
class PaymentMethodsApi
{
    ...
    public function deactivatePaymentMethodRequest($contact_id, $payment_method_id, string $contentType = self::contentTypes['deactivatePaymentMethod'][0])
    {
        ...
        $resourcePath = '/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}:deactivate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deletePaymentMethodRequest($contact_id, $payment_method_id, string $contentType = self::contentTypes['deletePaymentMethod'][0])
    {
        ...
        $resourcePath = '/v2/contacts/{contact_id}/paymentMethods/{payment_method_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Keap\Core\V2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Keap\Core\V2\Model\ListPaymentMethodsResponse|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error
     */
     ...
     * @throws \Keap\Core\V2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Keap\Core\V2\Model\ListPaymentMethodsResponse|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error|\Keap\Core\V2\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function listPaymentMethodsRequest($contact_id, $filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listPaymentMethods'][0])
    {
        ...
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentMethodsApi.listPaymentMethods, must be bigger than or equal to 1.');
        }
