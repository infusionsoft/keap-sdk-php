...
class UpdateSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets end_date
     *
     * @param string|null $end_date The date the subscription will end. Must not be in the past.
     *
     * @return self
     */
     ...
     * Sets next_bill_date
     *
     * @param string|null $next_bill_date The next date the subscription will bill. Must not be in the past.
     *
     * @return self
     */
