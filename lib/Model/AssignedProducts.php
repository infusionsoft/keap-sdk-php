...
/**
 * AssignedProducts Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class AssignedProducts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssignedProducts';
    ...
    */
     ...
     *
     * @param string|null $product_category_id The product category ID
     *
     * @return self
     */
     ...
     * Sets product_ids
     *
     * @param string[]|null $product_ids Assigned product IDs
     *
     * @return self
     */
