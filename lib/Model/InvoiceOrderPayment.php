...
class InvoiceOrderPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The invoice order payment ID.
     *
     * @return self
     */
     ...
     * Sets invoice_id
     *
     * @param string|null $invoice_id The invoice ID.
     *
     * @return self
     */
     ...
     * Sets payment_id
     *
     * @param string|null $payment_id The payment ID.
     *
     * @return self
     */
     ...
     * Sets pay_time
     *
     * @param \DateTime|null $pay_time The date and time of payment.
     *
     * @return self
     */
     ...
     * Sets pay_status
     *
     * @param string|null $pay_status The payment status.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_updated_time When this payment record was last updated.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $skip_commission Whether to skip commission for this payment.
     *
     * @return self
     */
     ...
     *
     * @param string|null $refund_invoice_payment_id The refund invoice payment ID, if this is a refund.
     *
     * @return self
     */
