...
/**
 * RestCreatePaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class RestCreatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestCreatePaymentRequest';
    ...
    */
     ...
     * Sets notes
     *
     * @param string|null $notes The notes for this payment.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_method_id The payment method id to charge immediately against this order. At least one of payment_method_id or payment_method_type is required. If payment_method_id is provided, payment_method_type is ignored. Omit if you want to add a payment record instead.
     *
     * @return self
     */
     ...
     * Sets payment_time
     *
     * @param \DateTime|null $payment_time The date and time of payment. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     * Sets payment_amount
     *
     * @param float $payment_amount The amount to pay. Must not exceed the current balance of the order. Must be greater than 0 if charging with a payment_method_id
     *
     * @return self
     */
     ...
     *
     * @param bool $apply_to_commissions Whether to apply this payment to commissions.
     *
     * @return self
     */
