...
class CreateFreeTrialDiscountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'criteria' => '\Keap\Core\V2\Model\CreateFreeTrialDiscountCriteria[]',
        'hide_price' => 'bool',
    ...
    */
     ...
     * Gets criteria
     *
     * @return \Keap\Core\V2\Model\CreateFreeTrialDiscountCriteria[]|null
     */
     ...
     * Sets criteria
     *
     * @param \Keap\Core\V2\Model\CreateFreeTrialDiscountCriteria[]|null $criteria List of criteria that must be met for this discount to apply
     *
     * @return self
     */
     ...
     * Sets hide_price
     *
     * @param bool|null $hide_price Whether to hide the price during the trial period
     *
     * @return self
     */
     ...
     *
     * @param string $subscription_plan_id ID of the subscription plan this trial applies to
     *
     * @return self
     */
     ...
     *
     * @param int|null $free_trial_days Number of free trial days. Must be a positive number. Defaults to 0.
     *
     * @return self
     */
