...
/**
 * BulkCreateDealNoteResponse Class Doc Comment
 *
 * @category Class
 * @description Response model for creating a deal note as part of a bulk operation.
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkCreateDealNoteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkCreateDealNoteResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('create_success', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the note.
     *
     * @return self
     */
     ...
     * Sets create_success
     *
     * @param bool|null $create_success Indicates whether the note was created successfully.
     *
     * @return self
     */
    public function setCreateSuccess($create_success)
    {
        if (is_null($create_success)) {
            throw new \InvalidArgumentException('non-nullable create_success cannot be null');
        }
     ...
     * Sets error_message
     *
     * @param string|null $error_message If the note creation was not successful, this field contains the error message.
     *
     * @return self
     */
