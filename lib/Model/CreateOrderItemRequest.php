...
class CreateOrderItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cost_per_unit
     *
     * @param float|null $cost_per_unit The cost per unit. Must be greater than or equal to 0. If not specified, the product cost will be used.
     *
     * @return self
     */
     ...
     * Sets price_per_unit
     *
     * @param float|null $price_per_unit The price per unit. Must be greater than or equal to 0. If not specified, the product price will be used.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string $product_id The id of the product to be added to the order. Must be a valid product id.
     *
     * @return self
     */
