...
/**
 * UpdateProductRequestDetail Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class UpdateProductRequestDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateProductRequest_Detail';
    ...
    */
     ...
     * Sets price
     *
     * @param int|null $price The product price. The value is in the currency's smallest unit. e.g. $12.50 is 1250. Must be greater than or equal to 0.
     *
     * @return self
     */
