...
class Webform implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets xid
     *
     * @param string|null $xid The public unique identifier for this webform, used in webform URLs
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTime|null $create_time When the webform was created
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param \DateTime|null $update_time When the webform was last updated
     *
     * @return self
     */
