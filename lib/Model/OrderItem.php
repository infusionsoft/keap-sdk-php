...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets item_type
     *
     * @param string|null $item_type The order item type. Valid values are: PRODUCT, SHIPPING, TAX, SERVICE, PRODUCT, UPSELL, FINANCE_CHARGE, DISCOUNT, PROGRAM, SUBSCRIPTION, DISCOUNT_FREE_TRIAL, DISCOUNT_ORDER_TOTAL, DISCOUNT_PRODUCT, DISCOUNT_PRODUCT_CATEGORY, DISCOUNT_SHIPPING, TIP, OTHER.
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\SubscriptionPlan|null $subscription_plan subscription_plan
     *
     * @return self
     */
