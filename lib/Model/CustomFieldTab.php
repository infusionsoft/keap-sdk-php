...
/**
 * CustomFieldTab Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldTab implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldTab';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the custom field tab
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the custom field tab
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int|null $order The display order of the tab
     *
     * @return self
     */
     ...
     * Sets record_type
     *
     * @param string|null $record_type The record type this tab belongs to (e.g., CONTACT, COMPANY, OPPORTUNITY, REFERRAL_PARTNER, ORDER, SUBSCRIPTION, TASK_NOTE_APPOINTMENT)
     *
     * @return self
     */
