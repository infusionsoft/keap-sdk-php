...
class CategoryDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'criteria' => '\Keap\Core\V2\Model\CategoryDiscountCriteriaResponse[]',
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for this category discount
     *
     * @return self
     */
     ...
     * Gets criteria
     *
     * @return \Keap\Core\V2\Model\CategoryDiscountCriteriaResponse[]|null
     */
     ...
     * Sets criteria
     *
     * @param \Keap\Core\V2\Model\CategoryDiscountCriteriaResponse[]|null $criteria List of criteria that must be met for this discount to apply
     *
     * @return self
     */
     ...
     *
     * @param float|null $discount_percent Percentage discount to apply (0-100)
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $product_categories List of product category IDs this discount applies to
     *
     * @return self
     */
