...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'last_bill_date' => 'setLastBillDate',
    ...
    protected static $getters = [
        ...
        'last_bill_date' => 'getLastBillDate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('last_bill_date', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Id of the subscription.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The subscription quantity.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Id of the product associated with the subscription.
     *
     * @return self
     */
     ...
     * Sets billing_amount
     *
     * @param float|null $billing_amount The billing amount.
     *
     * @return self
     */
     ...
     *
     * @param int|null $billing_frequency The billing frequency in days.
     *
     * @return self
     */
     ...
     * Sets billing_cycle
     *
     * @param string|null $billing_cycle The billing cycle of the subscription.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date The first day the subscription will bill.
     *
     * @return self
     */
    ...
    {
        return $this->container['last_bill_date'];
    }

    /**
     * Sets last_bill_date
     *
     * @param \DateTime|null $last_bill_date The last date the subscription was billed.
     *
     * @return self
     */
    public function setLastBillDate($last_bill_date)
    {
        if (is_null($last_bill_date)) {
            throw new \InvalidArgumentException('non-nullable last_bill_date cannot be null');
        }
        $this->container['last_bill_date'] = $last_bill_date;
     ...
     * Sets next_bill_date
     *
     * @param \DateTime|null $next_bill_date The next date the subscription will bill.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The last date the subscription will bill.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchant_account_id The merchant account id associated with the subscription.
     *
     * @return self
     */
     ...
     * Sets allow_tax
     *
     * @param bool|null $allow_tax If the subscription allows tax.
     *
     * @return self
     */
     ...
     *
     * @param int|null $max_charge_attempts Maximum number of charge attempts.
     *
     * @return self
     */
     ...
     *
     * @param int|null $days_between_retries Number of days between charge attempts.
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\Address|null $shipping_address The shipping address for the subscription.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_time The date and time the subscription was last modified.
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param \Keap\Core\V2\Model\CustomFieldValue[]|null $custom_fields List of custom field values applied to this subscription
     *
     * @return self
     */
