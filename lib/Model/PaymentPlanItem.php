...
/**
 * PaymentPlanItem Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class PaymentPlanItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentPlanItem';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'due_date' => '\DateTime',
        'amount_due' => '\Keap\Core\V2\Model\CurrencyValue',
        'amount_paid' => '\Keap\Core\V2\Model\CurrencyValue'
    ];
    ...
    public const STATUS_UNPAID_MANUAL = 'UNPAID_MANUAL';
    public const STATUS_UNPAID_AUTOCHARGE = 'UNPAID_AUTOCHARGE';
    ...
    {
        return [
            self::STATUS_UNPAID_MANUAL,
            self::STATUS_UNPAID_AUTOCHARGE,
            self::STATUS_PAID,
            self::STATUS_FAILED,
        ];
    }
    ...
    */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date The due date in the application's timezone, as an ISO 8601 calendar date string (date only), in the format YYYY-MM-DD
     *
     * @return self
     */
     ...
     * Sets amount_due
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $amount_due amount_due
     *
     * @return self
     */
     ...
     * Sets amount_paid
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $amount_paid amount_paid
     *
     * @return self
     */
