...
class Sequence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the sequence
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the sequence
     *
     * @return self
     */
     ...
     * Sets paths
     *
     * @param \Keap\Core\V2\Model\SequencePath[]|null $paths List of paths in this sequence
     *
     * @return self
     */
     ...
     *
     * @param int|null $active_contact_count Number of contacts currently in this sequence
     *
     * @return self
     */
     ...
     *
     * @param int|null $active_contact_count_completed Number of contacts who have completed this sequence
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\HistoricalCounts|null $historical_contact_count Historical contact counts for this sequence
     *
     * @return self
     */
