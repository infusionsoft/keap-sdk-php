 ...
 *
 * @category Class
 * @description A sent email record with full content
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class EmailSentWithContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the email
     *
     * @return self
     */
     ...
     *
     * @param string|null $sent_to_address The email address the email was sent to
     *
     * @return self
     */
     ...
     *
     * @param string|null $original_provider_id The original provider's message ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $original_provider The email provider that sent the email
     *
     * @return self
     */
     ...
     *
     * @param string|null $provider_source_id The synced email account that generated this message
     *
     * @return self
     */
     ...
     * Sets plain_content
     *
     * @param string|null $plain_content Base64 encoded plain text content
     *
     * @return self
     */
     ...
     * Sets html_content
     *
     * @param string|null $html_content Base64 encoded HTML content
     *
     * @return self
     */
