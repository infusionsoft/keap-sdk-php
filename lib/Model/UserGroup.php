 ...
 *
 * @category Class
 * @description A user group in the application
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UserGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for this user group.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of this user group.
     *
     * @return self
     */
