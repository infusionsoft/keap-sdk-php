...
class PaymentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Payment result ID
     *
     * @return self
     */
     ...
     * Sets payment_amount
     *
     * @param float|null $payment_amount Amount paid
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_status_message Payment status
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Transaction ID from payment processor
     *
     * @return self
     */
