...
class UpdateTaskResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $modification_time Last modification timestamp (ISO-8601)
     *
     * @return self
     */
     ...
     *
     * @param int|null $remind_time_mins Reminder minutes before due.
     *
     * @return self
     */
     ...
     *
     * @param string|null $created_by_user_id Creator user ID
     *
     * @return self
     */
