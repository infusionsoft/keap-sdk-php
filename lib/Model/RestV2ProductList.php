...
/**
 * RestV2ProductList Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class RestV2ProductList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestV2Product_List';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'price' => '\Keap\Core\V2\Model\CurrencyValueList',
        'active' => 'bool',
        'description' => 'string',
        'sku' => 'string',
        'shippable' => 'bool',
        ...
        'taxable' => 'bool',
        'categories' => 'string[]',
        'options' => '\Keap\Core\V2\Model\ProductOptionsList[]',
        'inventory' => '\Keap\Core\V2\Model\ProductInventoryList',
        ...
        'state_taxable' => 'bool',
        'city_taxable' => 'bool',
        'subscription_plans' => '\Keap\Core\V2\Model\SubscriptionPlanList[]'
    ];
    ...
    */
     ...
     * Gets price
     *
     * @return \Keap\Core\V2\Model\CurrencyValueList|null
     */
     ...
     * Sets price
     *
     * @param \Keap\Core\V2\Model\CurrencyValueList|null $price The product price
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Keap\Core\V2\Model\ProductOptionsList[]|null
     */
     ...
     * Sets options
     *
     * @param \Keap\Core\V2\Model\ProductOptionsList[]|null $options List of product options. Can be empty.
     *
     * @return self
     */
     ...
     * Gets inventory
     *
     * @return \Keap\Core\V2\Model\ProductInventoryList|null
     */
     ...
     * Sets inventory
     *
     * @param \Keap\Core\V2\Model\ProductInventoryList|null $inventory The inventory details for this product
     *
     * @return self
     */
     ...
     *
     * @return \Keap\Core\V2\Model\SubscriptionPlanList[]|null
     */
     ...
     *
     * @param \Keap\Core\V2\Model\SubscriptionPlanList[]|null $subscription_plans List of subscription plans associated with the product. Can be empty.
     *
     * @return self
     */
