 ...
 *
 * @category Class
 * @description Request model for creating a deal.
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateDealRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDealRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDealRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets value
     *
     * @return \Keap\Core\V2\Model\Money
     */
     ...
     * Sets value
     *
     * @param \Keap\Core\V2\Model\Money $value The monetary value of the deal. This field is required and must be valid.
     *
     * @return self
     */
