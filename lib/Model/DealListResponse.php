...
/**
 * DealListResponse Class Doc Comment
 *
 * @category Class
 * @description Response model for a list of deals.
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DealListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DealListResponse';
    ...
    */
     ...
     * Sets deals
     *
     * @param \Keap\Core\V2\Model\Deal[]|null $deals The list of Deals.
     *
     * @return self
     */
