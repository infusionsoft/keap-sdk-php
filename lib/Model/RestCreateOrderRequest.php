...
class RestCreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets terms
     *
     * @param string|null $terms Order terms
     *
     * @return self
     */
     ...
     * Sets contact_id
     *
     * @param string $contact_id ID of the contact for this order
     *
     * @return self
     */
     ...
     * Gets order_items
     *
     * @return \Keap\Core\V2\Model\CreateOrderItemRequest[]|null
     */
     ...
     * Sets order_items
     *
     * @param \Keap\Core\V2\Model\CreateOrderItemRequest[]|null $order_items List of items to include in the order
     *
     * @return self
     */
     ...
     * Sets order_title
     *
     * @param string $order_title Title for the order
     *
     * @return self
     */
     ...
     * Sets order_time
     *
     * @param \DateTime $order_time The date and time of the order. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     *
     * @param string|null $lead_affiliate_id Lead affiliate ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $sales_affiliate_id Sales affiliate ID
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\AddressInformation|null $shipping_address Shipping address for the order
     *
     * @return self
     */
