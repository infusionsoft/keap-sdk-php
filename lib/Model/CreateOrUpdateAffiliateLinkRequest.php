...
class CreateOrUpdateAffiliateLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['website_address'] === null) {
            $invalidProperties[] = "'website_address' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The Affiliate Link Name
     *
     * @return self
     */
     ...
     * Sets program_ids
     *
     * @param string[]|null $program_ids Program IDs to associate
     *
     * @return self
     */
