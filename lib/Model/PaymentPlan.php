...
class PaymentPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'payment_plan_items' => '\Keap\Core\V2\Model\PaymentPlanItem[]'
    ];
    ...
    protected static $setters = [
        ...
        'payment_plan_items' => 'setPaymentPlanItems'
    ];
    ...
    protected static $getters = [
        ...
        'payment_plan_items' => 'getPaymentPlanItems'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('payment_plan_items', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets auto_charge
     *
     * @param bool|null $auto_charge Whether to auto-charge payments
     *
     * @return self
     */
     ...
     *
     * @param int|null $max_charge_attempts Maximum charge attempts
     *
     * @return self
     */
     ...
     *
     * @param int|null $days_between_retries Days between retry attempts
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_method_id Payment method ID to charge
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\CurrencyValue|null $initial_payment_amount Initial payment amount
     *
     * @return self
     */
     ...
     *
     * @param float|null $initial_payment_percent Initial payment as percentage
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $initial_payment_date The initial payment date. In ISO-8601 date format (e.g. 2024-05-21)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $plan_start_date The start date of the payment plan. In ISO-8601 date format (e.g. 2024-05-21)
     *
     * @return self
     */
     ...
     *
     * @param int $number_of_payments Number of payments in the plan
     *
     * @return self
     */
     ...
     *
     * @param int $days_between_payments Days between each payment
     *
     * @return self
     */
    ...
    /**
     * Gets payment_plan_items
     *
     * @return \Keap\Core\V2\Model\PaymentPlanItem[]|null
     */
    public function getPaymentPlanItems()
    {
        return $this->container['payment_plan_items'];
    }

    /**
     * Sets payment_plan_items
     *
     * @param \Keap\Core\V2\Model\PaymentPlanItem[]|null $payment_plan_items List of scheduled payment items
     *
     * @return self
     */
    public function setPaymentPlanItems($payment_plan_items)
    {
        if (is_null($payment_plan_items)) {
            throw new \InvalidArgumentException('non-nullable payment_plan_items cannot be null');
        }
        $this->container['payment_plan_items'] = $payment_plan_items;
