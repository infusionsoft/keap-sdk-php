...
class UpdateUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets email_address
     *
     * @param \Keap\Core\V2\Model\EmailAddressRequest|null $email_address The user's email address
     *
     * @return self
     */
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone The user's timezone in IANA format
     *
     * @return self
     */
