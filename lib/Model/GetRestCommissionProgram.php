...
/**
 * GetRestCommissionProgram Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class GetRestCommissionProgram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRestCommissionProgram';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('affiliate_ids', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['affiliate_ids'];
    }

    /**
     * Sets affiliate_ids
     *
     * @param string[]|null $affiliate_ids The list of affiliate_ids using this commission program
     *
     * @return self
     */
    public function setAffiliateIds($affiliate_ids)
    {
        if (is_null($affiliate_ids)) {
            throw new \InvalidArgumentException('non-nullable affiliate_ids cannot be null');
        }
        $this->container['affiliate_ids'] = $affiliate_ids;
