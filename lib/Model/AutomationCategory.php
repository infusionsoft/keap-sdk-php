 ...
 *
 * @category Class
 * @description An automation category
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AutomationCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the category
     *
     * @return self
     */
     ...
     *
     * @param int|null $automation_count Number of automations in this category
     *
     * @return self
     */
