...
class PaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $payment_method_type The type of payment method. For now, only CARD is supported.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the payment method. Fow now, only EXPIRED is supported.
     *
     * @return self
     */
