...
/**
 * SubscriptionPlanList Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionPlanList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPlan_List';
    ...
    protected static $openAPITypes = [
        ...
        'plan_price' => '\Keap\Core\V2\Model\CurrencyValueList',
        'order_index' => 'int'
    ];
    ...
    */
     ...
     * Sets plan_price
     *
     * @param \Keap\Core\V2\Model\CurrencyValueList|null $plan_price The price of the subscription plan
     *
     * @return self
     */
