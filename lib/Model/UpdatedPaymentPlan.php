...
class UpdatedPaymentPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $initial_payment_amount Initial payment amount
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $initial_payment_date ISO date of the initial payment in pay plan
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $plan_start_date ISO date of the start of pay plan
     *
     * @return self
     */
     ...
     *
     * @param int|null $number_of_payments Number of payments in the plan
     *
     * @return self
     */
     ...
     *
     * @param int|null $days_between_payments Days between each payment
     *
     * @return self
     */
