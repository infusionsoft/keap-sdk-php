...
/**
 * UpdateDisplayPropertyRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDisplayPropertyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDisplayPropertyRequest';
    ...
    */
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order Determines the order for where this display property shows up on the group.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Identifies the custom field that is tied to this display property.
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \Keap\Core\V2\Model\DisplayPropertySource
     */
     ...
     * Sets source
     *
     * @param \Keap\Core\V2\Model\DisplayPropertySource $source Indicates whether this display property is a system or custom field.
     *
     * @return self
     */
