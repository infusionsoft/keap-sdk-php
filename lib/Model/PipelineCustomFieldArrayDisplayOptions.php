...
/**
 * PipelineCustomFieldArrayDisplayOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class PipelineCustomFieldArrayDisplayOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PipelineCustomFieldArrayDisplayOptions';
    ...
    protected static $openAPITypes = [
        'sortable' => 'bool',
        'item_options' => '\Keap\Core\V2\Model\PipelineCustomFieldDisplayOptions'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sortable'] === null) {
            $invalidProperties[] = "'sortable' can't be null";
        }
        if ($this->container['item_options'] === null) {
            $invalidProperties[] = "'item_options' can't be null";
        }
     ...
     * Sets sortable
     *
     * @param bool $sortable Indicates if the array is sortable.
     *
     * @return self
     */
     ...
     * Sets item_options
     *
     * @param \Keap\Core\V2\Model\PipelineCustomFieldDisplayOptions $item_options Display options for the items in the array. This field is required.
     *
     * @return self
     */
