...
/**
 * UpdateFreeTrialDiscountCriteria Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFreeTrialDiscountCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFreeTrialDiscountCriteria';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['criteria_id'] === null) {
            $invalidProperties[] = "'criteria_id' can't be null";
        }
     ...
     * Sets type
     *
     * @param string|null $type Type of criteria: DATE_RANGE, PROMO_CODE, PRODUCT, SUBSCRIPTION_PLAN, or ORDER_TOTAL
     *
     * @return self
     */
     ...
     * Sets criteria_id
     *
     * @param string $criteria_id Unique identifier for this criteria
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Product ID for PRODUCT criteria
     *
     * @return self
     */
     ...
     *
     * @param int|null $product_quantity_min Minimum product quantity for PRODUCT criteria
     *
     * @return self
     */
     ...
     *
     * @param int|null $product_quantity_max Maximum product quantity for PRODUCT criteria
     *
     * @return self
     */
     ...
     * Sets plan_id
     *
     * @param string|null $plan_id Subscription plan ID for SUBSCRIPTION_PLAN criteria
     *
     * @return self
     */
     ...
     *
     * @param int|null $subscription_quantity Subscription quantity for SUBSCRIPTION_PLAN criteria
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount Total amount threshold for ORDER_TOTAL criteria
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string|null $operator Comparison operator for ORDER_TOTAL criteria: LESS_THAN or GREATER_THAN
     *
     * @return self
     */
