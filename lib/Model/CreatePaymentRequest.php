...
class CreatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $apply_to_commissions Whether to apply this payment to commissions.
     *
     * @return self
     */
     ...
     * Sets payment_amount
     *
     * @param float|null $payment_amount The amount to pay. Must not exceed the current balance of the order. Must be greater than 0 if charging with a payment_method_id
     *
     * @return self
     */
     ...
     * Sets payment_time
     *
     * @param string|null $payment_time The date and time of payment. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
