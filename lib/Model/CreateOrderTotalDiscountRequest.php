...
class CreateOrderTotalDiscountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'criteria' => '\Keap\Core\V2\Model\CreateOrderTotalDiscountCriteria[]',
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Description of the discount
     *
     * @return self
     */
     ...
     * Gets criteria
     *
     * @return \Keap\Core\V2\Model\CreateOrderTotalDiscountCriteria[]|null
     */
     ...
     * Sets criteria
     *
     * @param \Keap\Core\V2\Model\CreateOrderTotalDiscountCriteria[]|null $criteria List of criteria that must be met for this discount to apply
     *
     * @return self
     */
     ...
     *
     * @param bool|null $apply_to_commissions Whether to apply this discount to commission calculations
     *
     * @return self
     */
     ...
     * Sets discount_type
     *
     * @param string $discount_type Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)
     *
     * @return self
     */
     ...
     * Sets discount_value
     *
     * @param float $discount_value Value of the discount (amount or percentage depending on discount_type)
     *
     * @return self
     */
     ...
     *
     * @param string|null $discount_strategy Strategy for applying discount: GROSS (before tax) or NET (after tax)
     *
     * @return self
     */
