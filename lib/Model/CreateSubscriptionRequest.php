...
class CreateSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \Keap\Core\V2\Model\AddressRequest|null $shipping_address shipping_address
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param string|null $start_date The first day the subscription will bill. Must not be in the past. Default is today.
     *
     * @return self
     */
