...
class CreateProductDiscountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'criteria' => '\Keap\Core\V2\Model\CreateProductDiscountCriteria[]',
    ...
    */
     ...
     * Gets criteria
     *
     * @return \Keap\Core\V2\Model\CreateProductDiscountCriteria[]|null
     */
     ...
     * Sets criteria
     *
     * @param \Keap\Core\V2\Model\CreateProductDiscountCriteria[]|null $criteria List of criteria that must be met for this discount to apply
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string $product_id ID of the product this discount applies to
     *
     * @return self
     */
