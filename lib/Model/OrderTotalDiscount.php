...
class OrderTotalDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for this order total discount
     *
     * @return self
     */
     ...
     * Sets discount_type
     *
     * @param string|null $discount_type Type of discount: AMOUNT (fixed amount) or PERCENT (percentage)
     *
     * @return self
     */
     ...
     * Sets discount_value
     *
     * @param float|null $discount_value Value of the discount (amount or percentage depending on discount_type)
     *
     * @return self
     */
