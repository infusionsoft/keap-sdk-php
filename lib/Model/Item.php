...
class Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_UNLAYER_EMAIL_CONFIRM = 'UnlayerEmailConfirm';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_UNLAYER_EMAIL_CONFIRM,
            self::TYPE_TAG,
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of flow item
     *
     * @return self
     */
     ...
     * Sets next_item_id
     *
     * @param string|null $next_item_id The ID of the next item in the sequence
     *
     * @return self
     */
     ...
     *
     * @param string|null $previous_item_id The ID of the previous item in the sequence
     *
     * @return self
     */
