...
/**
 * RestV2ProductDetail Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class RestV2ProductDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestV2Product_Detail';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'price' => '\Keap\Core\V2\Model\CurrencyValueDetail',
        'active' => 'bool',
        'description' => 'string',
        'sku' => 'string',
        'shippable' => 'bool',
        ...
        'taxable' => 'bool',
        'categories' => 'string[]',
        'options' => '\Keap\Core\V2\Model\ProductOptionsDetail[]',
    ...
    */
     ...
     * Sets price
     *
     * @param \Keap\Core\V2\Model\CurrencyValueDetail|null $price The product price
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Keap\Core\V2\Model\ProductOptionsDetail[]|null
     */
     ...
     * Sets options
     *
     * @param \Keap\Core\V2\Model\ProductOptionsDetail[]|null $options List of product options. Can be empty.
     *
     * @return self
     */
     ...
     *
     * @return \Keap\Core\V2\Model\SubscriptionPlanDetail[]|null
     */
     ...
     *
     * @param \Keap\Core\V2\Model\SubscriptionPlanDetail[]|null $subscription_plans List of subscription plans associated with the product. Can be empty.
     *
     * @return self
     */
