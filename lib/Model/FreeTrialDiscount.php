...
class FreeTrialDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for this free trial discount
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_plan_id ID of the subscription plan this trial applies to
     *
     * @return self
     */
     ...
     *
     * @param int|null $free_trial_days Number of days for the free trial period
     *
     * @return self
     */
