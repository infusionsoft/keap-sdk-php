...
class UpdateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets contact_id
     *
     * @param string|null $contact_id ID of the contact for this order
     *
     * @return self
     */
     ...
     * Sets order_title
     *
     * @param string|null $order_title Title for the order
     *
     * @return self
     */
     ...
     * Sets order_time
     *
     * @param \DateTime|null $order_time The date and time of the order. In ISO-8601 format (e.g. 2024-05-21T23:00:00Z)
     *
     * @return self
     */
     ...
     * Sets payment_plan
     *
     * @param \Keap\Core\V2\Model\UpdatedPaymentPlan|null $payment_plan Payment plan details
     *
     * @return self
     */
