...
class ProductCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The product category ID
     *
     * @return self
     */
     ...
     *
     * @param int|null $display_order_index Display order of the category
     *
     * @return self
     */
     ...
     *
     * @param string|null $parent_category_id Parent category ID for subcategories
     *
     * @return self
     */
