...
*UserGroupsApi* | [**getUserGroup**](docs/Api/UserGroupsApi.md#getusergroup) | **GET** /v2/userGroups/{user_group_id} | Retrieve an User Group
*UserGroupsApi* | [**listUserGroups**](docs/Api/UserGroupsApi.md#listusergroups) | **GET** /v2/userGroups | List User Groups
